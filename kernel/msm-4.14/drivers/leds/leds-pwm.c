...
#if defined(CONFIG_PRODUCT_IF_S1300N) || defined(CONFIG_PRODUCT_IF_S1500N) || defined(CONFIG_PRODUCT_IF_MKT300)
	#define USE_MARKT_LEDS_MISC	
	#define USE_MARKT_LEDS_ANIMATION
#endif


#if defined(CONFIG_PRODUCT_IF_S1300N) || defined(CONFIG_PRODUCT_IF_S1500N)
